...
tabsContainer.addEventListener('click', function (e) {
  ...
  // Remove active classes for tabs and content areas
  tabs.forEach(t => {
...
// const allButtons = document.getElementsByTagName('button'); // HTMLCollection which updates automatically
...
// // header.prepend(message); // first child of this element
...
// // Don't use, it overrides all existing classes
